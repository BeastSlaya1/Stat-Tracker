"use strict";
const releaseApi = "https://api.github.com/repos/BeastSlaya1/Stat-Tracker/releases/tags/v4.0.2";
const releasePrefix = "https://github.com/BeastSlaya1/Stat-Tracker/releases/download/v4.0.2/";
const platforms = {
  android: {name: "Stat-Tracker-Android-4.0.2.apk", size: 165997361, label: "Download for Android"},
  windows: {name: "Stat-Tracker-Windows-4.0.2-Setup.exe", size: 75074785, label: "Download for Windows"}
};
  ...
  try {
    ...
    for (const [id, platform] of Object.entries(platforms)) {
      ...
      if (asset) showLink(id, asset.browser_download_url, platform.label,
        "Version 4.0.2 · Download hosted on GitHub");
      else {
