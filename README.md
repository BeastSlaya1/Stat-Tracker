...
The accompanying Android APK and Windows installer are version 4.0.3. The
earlier 4.0.1 installers do not contain database synchronization. To rebuild
from this project root:

    python -m flet.cli build apk --project "Stat Tracker" --product "Stat Tracker" --org com.flet --permissions camera --build-version 4.0.3 --build-number 4 --yes
    python -m flet.cli build windows --project "Stat Tracker" --product "Stat Tracker" --build-version 4.0.3 --build-number 4 --yes
